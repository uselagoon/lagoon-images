...
LABEL org.opencontainers.image.source="https://github.com/uselagoon/lagoon-images/blob/main/images/varnish/8.Dockerfile"
LABEL org.opencontainers.image.description="Varnish 8 image optimised for running in Lagoon in production and locally"
