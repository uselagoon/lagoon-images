...
LABEL org.opencontainers.image.source="https://github.com/uselagoon/lagoon-images/blob/${LAGOON_VERSION}/images/mysql/8.0.Dockerfile"
...
LABEL org.opencontainers.image.title="${IMAGE_REPO}/mysql-8.0"
