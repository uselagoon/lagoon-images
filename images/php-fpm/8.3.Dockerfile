...
LABEL org.opencontainers.image.source="https://github.com/uselagoon/lagoon-images/blob/${LAGOON_VERSION}/images/php-fpm/8.3.Dockerfile"
...
LABEL org.opencontainers.image.title="${IMAGE_REPO}/php-8.3-fpm"
LABEL org.opencontainers.image.base.name="docker.io/php:8.3-fpm-alpine3.19"
