...
LABEL org.opencontainers.image.source="https://github.com/uselagoon/lagoon-images/blob/${LAGOON_VERSION}/images/php-cli-drupal/8.3.Dockerfile"
...
LABEL org.opencontainers.image.title="${IMAGE_REPO}/php-8.3-cli-drupal"
