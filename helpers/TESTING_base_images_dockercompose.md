...
docker run --rm --net all-images_default jwilder/dockerize dockerize -wait tcp://php-8-5-dev:9000 -timeout 1m
```
...
docker ps --filter label=com.docker.compose.project=all-images | grep Up | grep php-8-5-dev
docker ps --filter label=com.docker.compose.project=all-images | grep Up | grep php-8-5-prod
...
docker compose exec -T commons sh -c "curl -kL http://php-8-1-dev:9000" | grep "Brotli support" | grep "enabled"
...
# PHP 8.5 development should have PHP installed
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "PHP Version" | grep "8.5"
docker compose exec -T php-8-5-dev bash -c "php -i" | grep "PHP Version" | grep "8.5"
...
# PHP 8.5 development should have default configuration.
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "memory_limit" | grep "400M"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "short_open_tag" | grep "On"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "max_execution_time" | grep "900"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "max_input_time" | grep "900"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "post_max_size" | grep "2048M"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "max_input_vars" | grep "2000"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "max_file_uploads" | grep "20"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "session.cookie_samesite" | grep "no value"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "display_errors" | grep "Off"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "date.timezone" | grep "UTC"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "opcache.memory_consumption" | grep "256"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-dev:9000" | grep "error_reporting" | grep "22527"
docker compose exec -T php-8-5-dev bash -c "php -i" | grep "sendmail_path" | grep "/usr/sbin/sendmail -t -i"

# PHP 8.5 development should have extensions enabled.
...
docker compose exec -T commons sh -c "curl -kL http://php-8-5-prod:9000" | grep "max_file_uploads" | grep "40"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-prod:9000" | grep "session.cookie_samesite" | grep "Strict"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-prod:9000" | grep "upload_max_filesize" | grep "1024M"
docker compose exec -T commons sh -c "curl -kL http://php-8-5-prod:9000" | grep "error_reporting" | grep "22519"
...
# python-3-14 should be version 3.14
docker compose exec -T python-3-14 sh -c "python -V" | grep "3.14"

# python-3-14 should have basic tools installed
docker compose exec -T python-3-14 sh -c "pip list --no-cache-dir" | grep "pip"
docker compose exec -T python-3-14 sh -c "pip list --no-cache-dir" | grep "virtualenv"
